...
public class UserAssemble {
    public BasicUserVO assemble(UserProfileDTO basicUser, String size) {
...
//        }
        ...
        basicUserVo.setCreateTime(DateTimeUtility.getFormatTime(basicUser.getGmtCreate(), DateTime.FORMAT_YYYY_MM_DD_HH_MM_SS));
